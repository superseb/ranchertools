...
* Cluster reset from non boostrap nodes [(#8451)](https://github.com/k3s-io/k3s/pull/8451)
* Take IPFamily precedence based on order [(#8504)](https://github.com/k3s-io/k3s/pull/8504)
* Fix spellcheck problem (boostrap ==> bootstrap) [(#8509)](https://github.com/k3s-io/k3s/pull/8509)
