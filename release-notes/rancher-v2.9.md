...
| ------- | ---- | ------- | ------- |
| [v2.9.5](rancher-v2.9.md#release-v295) | Dec 19 2024 | 12/19/24 | 2024-12-19 |
...
Rancher v2.9.5 is the latest patch release of Rancher v2.9. This is a Prime version release that introduces maintenance updates and bug fixes. To learn more about Rancher Prime, see our page on the [Rancher Prime Platform](https://www.rancher.com/products/rancher-platform).
...
- Fixed a file permission issue where after upgrading to Rancher v2.9.3 or newer and deleting a node (i.e., scaling down a node pool) that was present before the upgrade would result in the node being removed from Rancher and the downstream cluster, but the underlying virtual machine is not removed from the infrastructure provider. See [#48343](https://github.com/rancher/rancher/issues/48343).

## K3s Provisioning

### Major Bug Fixes

- Fixed an issue where upgrading the K8s version of the downstream node driver and custom K3s clusters may result in an etcd node reporting `NodePressure`, and eventually the `rancher-system-agent` reporting failures to execute plans. If this issue is encountered, it can be solved by performing a `systemctl restart k3s.service` on the affected etcd-only nodes. See [#48097](https://github.com/rancher/rancher/issues/48097).
...
- Clusters containing nodes with split etcd and control plane roles may fail to reconcile when upgrading Rancher. The following can be seen repeatedly in the control plane logs:
  ...
  See [#48390](https://github.com/rancher/rancher/issues/48390).
...
- Users are able to create or edit clusters even when using an invalid Add-on YAML configuration. See [#12324](https://github.com/rancher/dashboard/issues/12324).
...
- rancher/rancher:v2.9.5

## Tools

- CLI - [v2.9.5](https://github.com/rancher/cli/releases/tag/v2.9.5)
- RKE - [v1.6.5](https://github.com/rancher/rke/releases/tag/v1.6.5)
...
## All issues in v2.9.5 milestone

* [#48432](https://github.com/rancher/rancher/issues/48432) [2.9] [BUG] Panic in nodesyncer
* [#48343](https://github.com/rancher/rancher/issues/48343) [Backport v2.9] [BUG] VM of existing RKE1 node is not removed after the node is deleted from the cluster after upgrading to Rancher 2.9.3+
* [#48306](https://github.com/rancher/rancher/issues/48306) [BUG][2.9] script user-cluster.sh fails to cleanup Rancher Components from Registered Clusters 
* [#48200](https://github.com/rancher/rancher/issues/48200) [backport v2.9] [BUG] rancher-monitoring ignoreNamespaceSelectors has wrong default value
* [#48164](https://github.com/rancher/rancher/issues/48164) [Backport 2.9]  Add managed annotation to Chart.yaml in rancher-provisioning-capi helm chart
* [#48154](https://github.com/rancher/rancher/issues/48154) [v2.9] Update ACI-CNI to 6.0.4.4
* [#48144](https://github.com/rancher/rancher/issues/48144) [SURE-9393] Rancher crash looping (panic) after provisioning an EKS cluster
* [#48123](https://github.com/rancher/rancher/issues/48123) [Backport] [v2.9]  CIS: Unexpected Failures in scans for gke 1.6.0 profile
* [#48097](https://github.com/rancher/rancher/issues/48097) [Backport v2.9] Nodes may fail to reconnect after K8s upgrade for K3s clusters with multiple etcd-only nodes
* [#48087](https://github.com/rancher/rancher/issues/48087) [Backport 2.9] [BUG] `legacy-rolebinding-ownerref-cleaner` handlers fire millions of times per hour
* [#48082](https://github.com/rancher/rancher/issues/48082) [v2.9] KDM Update for K8s November 2024 patch 
* [#48065](https://github.com/rancher/rancher/issues/48065) [Backport 2.9] rancher-provisioning-capi chart version is not being pinned
* [#48051](https://github.com/rancher/rancher/issues/48051) [backport v2.9] [BUG] Remove mirrored-prometheus-windows-exporter from rancher-images.txt
* [#48004](https://github.com/rancher/rancher/issues/48004) [Backport 2.9] ranchercli - readable warning that give no meaning on windows
* [#47980](https://github.com/rancher/rancher/issues/47980) [Backport v2.9] Stale Secret Fix
* [#47831](https://github.com/rancher/rancher/issues/47831) [v2.9] [BUG] Endpoint /v3/principal returns 500 when the principal can't be found
* [#47752](https://github.com/rancher/rancher/issues/47752) [Backport v2.9] Upgrade gomock dependency
* [#47733](https://github.com/rancher/rancher/issues/47733) [2.9] [Backport] Enhance the logging messages for `rkeworkerupgrader`
* [#47348](https://github.com/rancher/rancher/issues/47348) [Backport v2.9][BUG] Only apply "auth-prov-v2-" finalizers to necessary resources
* [#47251](https://github.com/rancher/rancher/issues/47251) [BUG] Azure AD China auth returning "error status code received from the API"
-----
# Release v2.9.4
...
* [#47718](https://github.com/rancher/rancher/issues/47718) [Backport v2.9] Windows system-agent-install script needlessly reinstalls RKE2 
...
* [#25073](https://github.com/rancher/rancher/issues/25073) user-data.iso files not removed from datastore upon deleting vSphere nodes
-----
# Release v2.9.0
