...
| ------- | ---- | ------- | ------- |
| [v2.8.11](rancher-v2.8.md#release-v2811) | Dec 19 2024 | 12/19/24 | 2024-12-19 |
| [v2.8.10](rancher-v2.8.md#release-v2810) | Nov 18 2024 | 11/18/24 | 2024-11-18 |
...
Rancher v2.8.11 is the latest patch release of Rancher v2.8. This is a Prime version release that introduces maintenance updates and bug fixes. To learn more about Rancher Prime, see our page on the [Rancher Prime Platform](https://www.rancher.com/products/rancher-platform).

For more information on new features in the general minor release see the [v2.8.0 release notes](https://github.com/rancher/rancher/releases/tag/v2.8.0).

## RKE Provisioning

### Major Bug Fixes

- Fixed a file permission issue where after upgrading to Rancher v2.8.9 or newer and deleting a node (i.e., scaling down a node pool) that was present before the upgrade would result in the node being removed from Rancher and the downstream cluster, but the underlying virtual machine is not removed from the infrastructure provider. See [#48342](https://github.com/rancher/rancher/issues/48342).
...
## All issues in v2.8.11 milestone

* [#48412](https://github.com/rancher/rancher/issues/48412) [v2.8] bump kubectl in rancher-cis-benchmark chart 
* [#48342](https://github.com/rancher/rancher/issues/48342) [Backport v2.8] [BUG] VM of existing RKE1 node is not removed after the node is deleted from the cluster after upgrading to Rancher 2.9.3+/2.8.9+
* [#47542](https://github.com/rancher/rancher/issues/47542) [2.8] Add CIS-1.9 Kubernetes (v1.27-1.29)
* [#47151](https://github.com/rancher/rancher/issues/47151) [BUG] CLI version is missing in the Versions table in the About page for `v2.8.8-alpha2`
* [#43343](https://github.com/rancher/rancher/issues/43343) script `user-cluster.sh` fails to cleanup Rancher Components from Registered Clusters 
-----
# Release v2.8.10

> **Important:** Review the Install/Upgrade Notes before upgrading to any Rancher version.

Rancher v2.8.10 is the latest patch release of Rancher v2.8. This is a Prime version release that introduces maintenance updates and bug fixes. To learn more about Rancher Prime, see our page on the [Rancher Prime Platform](https://www.rancher.com/products/rancher-platform).
...
- Fixed an issue where clusters may fail to get provisioned when the `provisioningprebootstrap` feature is enabled and the Authorized Cluster Endpoint (ACE) or certain customized chart deployments are used. See [#47810](https://github.com/rancher/rancher/issues/47810).
...
- Fixed a permission issue which led to failures when attempting to provision an RKE1 cluster on vSphere. See [#47941](https://github.com/rancher/rancher/issues/47941).
...
## All issues in v2.8.10 milestone

* [#47941](https://github.com/rancher/rancher/issues/47941) [Backport 2.8] Cannot Provision RKE1 on vSphere
* [#47816](https://github.com/rancher/rancher/issues/47816) [Backport v2.8] [BUG] `provisioningprebootstrap` flag does not restart rancher when toggled
* [#47810](https://github.com/rancher/rancher/issues/47810) [Backport v2.8] [BUG] Failed bootstrapping cluster with provisioningprebootstrap and ACE enabled
* [#47790](https://github.com/rancher/rancher/issues/47790) [v2.8] Update CNI Plugins source in rke-tools
* [#47710](https://github.com/rancher/rancher/issues/47710) [v2.8] Enable metrics in nginx template, bump nginx to 1.11.3
* [#47605](https://github.com/rancher/rancher/issues/47605) [Backport][v2.8] [BUG] Unable to create the CIS scan output because of the configMap size is exceeding 1 MB
* [#47535](https://github.com/rancher/rancher/issues/47535) [v2.8] KDM Update for K8s October 2024 patch
* [#47524](https://github.com/rancher/rancher/issues/47524) [Backport v2.8] [BUG] Downstream RKE2 registry rewrites break fallback to upstream registry
-----
# Release v2.8.9
