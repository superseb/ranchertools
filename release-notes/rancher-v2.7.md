...
Starting with Rancher v2.7.2, a webhook is now installed in all downstream clusters, to validate and enforce certain boundaries. A [Known Issue](#known-issues) involves behavior during rollbacks; see that section of the release notes for advice and instructions. See [#40816](https://github.com/rancher/rancher/issues/40816).
